...
public class update_details extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue. invokeLater(new Runnable() {
			public void run() {
				...
				try {
					update_details frame = new update_details();
	...
	public update_details() {
		...
		l1.setFont(new Font("Times new Roman",Font.PLAIN,42));
			...
			public void actionPerformed(ActionEvent e) {
				...
				String dbpassword="";
				  ...
				  try {
	                    ...
	                    String updateQuery = "UPDATE add_customer SET Name=?,Age=?,Dateofbirth=?,Address=?,Phone=?,Emailid=?,Country=?,Gender=?,city=? WHERE userid=?";
	                    ...
	                    updateStatement.setString(6,Emailid);
	                    updateStatement.setString(7,Country);
	                    updateStatement.setString(8,Gender);
	                    updateStatement.setString(9,city);
	                    ...
	                    if (rowsUpdated > 0) {
	                        ...
	                        JOptionPane.showMessageDialog(b1, "Data Updated Successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
	                    } else {
	                        JOptionPane.showMessageDialog(b1, "No data updated. Product code not found.", "Error", JOptionPane.ERROR_MESSAGE);
	                    }
	                } catch (Exception e1) {
	                    e1.printStackTrace();
	                }
		...
		b3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("Searching for product with code: "+userid);
		...
		ImageIcon icon = new ImageIcon("lmagesn/78.jpg");
		...
		ImageIcon icon1 = new ImageIcon("lmagesn/300.jpg");
