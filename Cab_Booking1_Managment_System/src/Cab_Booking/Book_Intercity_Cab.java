...
public class Book_Intercity_Cab extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue. invokeLater(new Runnable() {
			public void run() {
				...
				try {
					Book_Intercity_Cab frame = new Book_Intercity_Cab ();
	...
	public Book_Intercity_Cab ()  {
		...
		JLabel l1=new JLabel("Book Intercity cab");
		...
		b1.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String insertQuery="INSERT INTO Book_Intercity_Cab (vehicle_id,username,destination_to,destination_from,cab_number,cab_type,owner_id)VALUES(?,?,?,?,?,?,?)";
		...
		ImageIcon icon = new ImageIcon("lmagesn/7.jpeg");
		...
		b3.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (kilometers > 0 && kilometers < 15) {
		            Total_price = (kilometers * 60)+100;
		        } else if (kilometers >= 15 && kilometers < 30) {
		            Total_price = (kilometers * 80)+200;
		        } else if (kilometers >= 30 && kilometers < 50) {
		            Total_price =( kilometers * 100)+400;
		        } else if (kilometers >= 50 && kilometers < 80) {
		            Total_price = (kilometers * 120)+600;
		        } else if (kilometers >= 80 && kilometers <= 100) {
		            Total_price = (kilometers * 150)+800;
		        }
		        else if( kilometers > 100) {
		        	Total_price = (kilometers * 180)+1000;
		        }
